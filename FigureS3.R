...
#### Generate plots comparing performance of PLRT w/ misspecification, p=10, K=3 ####
p=10
K=3
...
df_comp_per <- df[df$Method %in% c("test_indep_per", "test_indep_perK2", 
                                   "test_indep_perK4"), ]
df_comp_per$Method <- factor(df_comp_per$Method, 
                             levels=c("test_indep_per", "test_indep_perK2", 
                                      "test_indep_perK4"))
...
df_comp_per2 <- df[df$Method %in% c("test_indep_per", "test_indep_perK2", 
                                    "test_indep_perK4"), ]
...
df_comp_per3 <- df[df$Method %in% c("test_indep_per", "test_indep_perK2", 
                                    "test_indep_perK4"), ]
